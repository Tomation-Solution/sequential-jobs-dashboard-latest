...
interface EmployersDeleteAccountModalProps {
  handleCloseModal: () => void;
  selectedRowData:object|null
}

const EmployersDeleteAccounttModal = ({
  handleCloseModal,selectedRowData
}: EmployersDeleteAccountModalProps) => {
  if (selectedRowData){
...
export default EmployersDeleteAccounttModal;
